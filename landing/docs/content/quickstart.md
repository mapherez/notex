...
Changes save locally as you edit. You do not need to export a note to save it.

For a first note, try a simple project reference: a block for the goal, a block for useful links, and a block for decisions. Read [notes and blocks](blocks.md) when you want to reorganize it.

## Make it easy to find

Add a collection for the note's main subject, and tags for topics that might apply to other notes too. You can also mark it as a favorite or pin it.

You can adjust this organization later; it does not need to be perfect before you start writing.
